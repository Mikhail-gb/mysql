...
-- Домашнее задание.
-- Добавить поле likes в таблицу users
ALTER TABLE users ADD COLUMN likes BIGINT DEFAULT 0;

-- Добавить поле likes в таблицу media
ALTER TABLE media ADD COLUMN likes BIGINT DEFAULT 0;

-- Добавить поле likes в таблицу messages
ALTER TABLE messages ADD COLUMN likes BIGINT DEFAULT 0;
